...
<ul>
    <li><h2>Navigation</h2>
        <ul>
            ...
            <img src="documentation/header-navigation.jpg" alt="picture of header navigation"> 
            ...
            <img src="documentation/footer-navigation.jpg" alt="picture of footer navigation">
            ...
            <img src="documentation/main-section-navigation.jpg" alt="picture of main section navigation">
            ...
            <img src="documentation/mobile-device-navigation.jpg" alt="picture of main section navigation used on a mobile device">
    ...
    <li><h2>Download Button</h2>
        <ul>
            ...
            <img src="documentation/download-button.jpg" alt="picture of download button">
            <img src="documentation/download-button-highlighted.jpg" alt="picture of download button highlighted">
        </ul>
    </li>
    <br>
    <li><h2>Feedback Form</h2>
        <ul>
            ...
            <img src="documentation/feedback-form-container.jpg" alt="picture of feedback form">
            <img src="documentation/submit-button-highlightedjpg.jpg" alt="picture of submit button highlighted">
        </ul>
    </li>
    <li><h2>Transform and Transition Properties</h2>
        <ul>
            ...
            <img src="documentation/github-highlight.jpg" alt="picture of github link highlighted">
            <img src="documentation/linkedin-highlight.jpg" alt="picture of linkedin link highlighted">
            ...
            <img src="documentation/loading-page.gif" alt="picture of the loading page in gif format on loop">
        </ul>
    </li>
<br>
...
<ul>
    <li>Accessibility</li>
        <ul>
            ...
            <img src="documentation/lighthouse-home.jpg" alt="picture of github link highlighted">
            <br>
            <br>
            <img src="documentation/lighthouse-cv.jpg" alt="picture of github link highlighted">
            <br>
            <br>
            <img src="documentation/lighthouse-feedback.jpg" alt="picture of github link highlighted">
        </ul>
</ul>
